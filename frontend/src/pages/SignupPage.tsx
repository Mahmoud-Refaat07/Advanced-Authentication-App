...
const SignupPage = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-md w-full bg-gary-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden"
    >
      <div className="p-8">
        ...
        <form onSubmit={handleSignUp}>
          ...
          focus:ring-offset-gray-900 transition durtion-200
          "
      ...
      <div className="px-8 py-4 bg-ray-900 bg-opacity-50 flex justify-center">
