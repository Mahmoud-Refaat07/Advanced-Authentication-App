...
import { lastLoginDate, joinedDate } from "../utils/date";
...
const DashboardPage = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-md w-full mx-auto mt-10 p-8 bg-gray-900/50 backdrop-blur-lg rounded-xl shadow-2xl border border-gray-800"
    >
